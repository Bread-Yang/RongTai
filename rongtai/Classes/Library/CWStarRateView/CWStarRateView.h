...
typedef NS_ENUM(NSUInteger, WLStarRateViewType)
{
    WLStarRateViewContinuousType = 0,  //连续评分
    WLStarRateViewHalfType,            //半星评分
    WLStarRateViewCompleteType,        //全星评分
};
...
@property (nonatomic)WLStarRateViewType starRateType;  //评分类型
