...
@property (readwrite, nonatomic, strong) UIColor    *segmentNormalTextColor;
...
- (THSegmentedControlSegment *)segmentLabelWithFrame:(CGRect)frame text:(NSString *)text
{
	...
	segLabel.segmentNormalTextColor = self.borderColor;
...
- (UIView *)segmentSeperatorWithFrame:(CGRect)seperatorFrame
{
    ...
    segSeperator.backgroundColor = self.borderColor;
    return segSeperator;
}
...
#pragma mark - Border Color Setter
...
- (void)commonInit {
	...
	self.textField.textColor = self.segmentNormalTextColor;
...
- (void)setSegmentNormalTextColor:(UIColor *)segmentNormalTextColor {
	_segmentNormalTextColor = segmentNormalTextColor;
	self.textField.textColor = segmentNormalTextColor;
}
