...
- (UIView *)createContainerView {
	...
	dialogContainer.clipsToBounds = YES;
	if (self.dialogBackgroundColor) {
		dialogContainer.backgroundColor = self.dialogBackgroundColor;
	} else {
		dialogContainer.backgroundColor = BACKGROUND_COLOR;
	}
	...
	if (self.dividerColor) {
		...
		lineView.backgroundColor = DIVIDER_COLOR;
	}
...
- (CGSize)countDialogSize {
	...
	CGFloat dialogWidth = containerView.frame.size.width;
	CGFloat dialogHeight = containerView.frame.size.height + titleHeight + buttonHeight + buttonSpacerHeight;
