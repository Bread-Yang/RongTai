...
//  SilverlitDog
//
//  Created by liu junjie on 13-1-7.
//  Copyright (c) 2013年 Silverlit. All rights reserved.
//

#ifndef SilverlitDog_PinYinUti_h
#define SilverlitDog_PinYinUti_h
...
CG_INLINE char pinyinFirstLetter(unsigned short hanzi) {
